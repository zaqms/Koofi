...
| `meet_halfway_results` | ثلاث قهاوي أنسب لكم الاثنين (or leftover 1–2) shown | `locale`, `count`, `source` (`local` / `invite`) |
