...
function ChipIcon({ id }: { id: string }) {
  switch (id) {
    ...
    case "drive-through":
      return (
        <Icon>
          {/* front car + pickup post/sign with takeaway cup */}
          <path d="M4.6 8.4C4.9 7.2 5.8 6.4 7.2 6.4H8.6C10.0 6.4 10.9 7.2 11.2 8.4L11.8 12.6H3.9Z" />
          <path d="M4.35 9.6H3.2" />
          <path d="M11.45 9.6H12.6" />
          <path d="M5.1 11.6H6.4" />
          <path d="M9.3 11.6H10.6" />
          <path d="M4.2 12.6H11.6" />
          <rect x="4.5" y="13.0" width="2.0" height="1.35" rx="0.5" />
          <rect x="9.2" y="13.0" width="2.0" height="1.35" rx="0.5" />
          <path d="M15.0 17.8V5.6H21.0" />
          <path d="M13.6 17.8H16.4" />
          <rect x="16.2" y="7.4" width="5.2" height="5.2" rx="0.85" />
          <path d="M17.45 9.0L17.7 11.55H19.9L20.15 9.0Z" />
          <path d="M17.25 9.0H20.35" />
