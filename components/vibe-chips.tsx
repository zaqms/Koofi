  ...
  switch (id) {
    ...
    case "drive-through":
      return (
        <Icon>
          {/* cup at window */}
          <rect x="3.2" y="3.8" width="10.2" height="16.4" rx="1.4" />
          <path d="M3.2 9h10.2" />
          <path d="M9.4 11.4h6.4a2.5 2.5 0 0 1 0 5H9.4" />
          <path d="M9.4 11.4v5c0 1.35 1 2.45 2.35 2.45h1.2" />
          <path d="M11.5 9.2c.4-.5.4-1 0-1.5" />
          <path d="M13.7 9.2c.4-.5.4-1 0-1.5" />
        </Icon>
      );
    case "matcha":
      return (
