...
const CNI_BLURBS_AR: Record<string, string> = {
  ...
  "anotherside-cafe-al-munsiyah": `**أنذرسايد** موجودة بقائمة wain.lol لحي المونسية بالرياض. نفس صفحة الحي مع شرب وايجل، دبوسها هي. انتقل لبطاقات المونسية الثانية تحت إذا تبي اسم ثاني.`,
};
