...
العدد عشر لأن هذا اللي ضفناه من النهضة.`,
    ...
    hereOutro: `افتح البطاقة إذا الاسم يمشي، بعدين **ودّني هناك** للدبوس. الساعات تبقى على قوقل ماب.`,
    nearbyIntro: `إذا النهضة مو الوقف، هالقوائم شرق الرياض جنبكم بالموقع:`,
...
const CNI_BLURBS_AR: Record<string, string> = {
  ...
  "kapu-cafe-al-nahdah": `**كابو محمصة وقهوة** بقائمة النهضة على wain.lol. وسوم الكتالوج على البطاقة: محمصة. باقي أسماء النهضة تحت إذا هذي مو الوقف.`,
  "dahal-specialty-al-nahdah": `**ضحل قهوة مختصة** بالكتالوج في النهضة — دبوسها هي. باقي أسماء النهضة اللي ضفناها مربوطة تحت.`,
  "ghazala-cafe-al-nahdah": `هذي صفحة **غزالة كافيه** على wain.lol للنهضة. باقي أسماء النهضة بالكتالوج تحت إذا تبي تبقى بهالحي.`,
  "shafel-roastery-al-nahdah": `**محمصة قهوة شفل** موجودة بقائمة wain.lol لحي النهضة بالرياض. وسوم الكتالوج على البطاقة: محمصة. نفس صفحة الحي مع كابو وعنوان القهوة، دبوسها هي. انتقل لبطاقات النهضة الثانية تحت إذا تبي اسم ثاني.`,
  "half-ten-al-nahdah": `**هاف تن** من قهاوي النهضة على wain.lol. إذا أنت بهالحي وتبي هالبطاقة، أنت بالمكان الصح. باقي كتالوج النهضة مربوط تحت.`,
  "bon-ferro-al-nahdah": `النهضة فيها **بون فيرو قهوة مختصة** بالكتالوج. هذي البطاقة إذا تبي هالاسم من قائمة النهضة. الباقي بنفس الحي تحت.`,
  "coffee-address-al-nahdah": `**عنوان القهوة** بالكتالوج في النهضة على wain.lol. هذي دبوس النهضة. ما نخترع زيادة؛ قهاوي النهضة الثانية اللي ضفناها مربوطة تحت.`,
  "chord-daily-coffee-al-nahdah": `**كورد قهوة يومية** بقائمة النهضة. أماكن النهضة الثانية بالكتالوج تحت.`,
  "taco-cup-al-nahdah": `**تاكو كب قهوة مختصة** موجودة بقائمة wain.lol لحي النهضة بالرياض. نفس صفحة الحي مع كابو وغزالة، دبوسها هي. انتقل لبطاقات النهضة الثانية تحت إذا تبي اسم ثاني.`,
  "awj-cafe-al-nahdah": `النهضة فيها **اوج كافيه** بالكتالوج. البطاقة هنا إذا تبي دبوس الخريطة من قائمة هالحي. أماكن النهضة الثانية على wain.lol تحت.`,
};
