...
الرياض بس للحين. ناقصك مكان؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  "al-hamra": {
    lead: `الحمراء على الحزام الشرقي من الرياض — نفس جهة غرناطة وقرطبة، مو صفحة كافد ومو اللفّة الشمالية. هذي مجموعة الحمراء على wain.lol: عشر قهاوي ضفناها فعلاً، وكل وحدة عليها دبوس قوقل ماب.
...
الرياض بس للحين. ناقصك مكان؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  "al-yarmouk": {
    lead: `اليرموك أبعد شرقًا من الحمراء — باتجاه الدائري الشرقي، مو نفس عشر بطاقات الحمراء، ومو صفحة شمال الرياض ولا كافد. إذا أنت بهالجهة وتبي قهوة من الكتالوج، هذي مجموعة اليرموك على wain.lol.
...
العدد عشر لأن هذا اللي ضفناه من اليرموك — مو إن هالحي شريط قهوة ثاني شرق الرياض.`,
...
الرياض بس للحين. ناقصك مكان؟ ارمي رابط قوقل ماب من الموقع.`,
    meta: "عشر قهاوي باليرموك على wain.lol — قائمة شرق الرياض بعد الحمراء فيها سايلو ونوساوند وريشيو، وكل وحدة عليها رابط قوقل ماب.",
  },
};

const CNI_BLURBS_AR: Record<string, string> = {
  "core-coffee-and-roastery-al-narjis": `تدور قهوة بالنرجس شمال الرياض؟ **كور قهوة ومحمصة** موجودة بقائمتنا لهالحي — نفس صفحة النرجس مع كاف لاب وريبوستري، مو قائمة كافد. إذا تبي اسم ثاني من نفس القائمة الشمالية، الباقي تحت.`,
  "caf-lab-al-narjis": `**كاف لاب** من أماكن النرجس على wain.lol. إذا أنت شمال وتبي هالمحل، أنت بالمكان الصح — مو صفحة كافد، مو ترتيب المدينة. باقي أسماء النرجس بالكتالوج مربوطة تحت إذا تبي تنتقل بنفس الحي.`,
  ...
  "jazel-speciality-cafe-diriyah": `**جازل** بقائمة الدرعية على wain.lol — غرب اللفّة الشمالية المعتادة، مو مطوية مع العليا ولا كافد. إذا هذي مو الوقف، أماكن الدرعية الثانية بنفس قائمة الحي مربوطة تحت — بس اللي ضفناه فعلاً.`,
  ...
  "taim-specialty-coffee-as-sahafah": `**تَيْم** بقائمة الصحافة، جنب كافد بس مو على صفحة كافد. باقي أسماء الصحافة اللي ضفناها مربوطة تحت — قائمة قصيرة، بس اللي بالكتالوج. ما نخترع مجموعة أطول عشان الصفحة تبين مشغولة.`,
  "archi-ghirnatah": `**ارتشي غرناطة** بقائمة غرناطة — شرق الرياض، جهة ثانية عن كافد. أماكن جهة غرناطة الثانية على wain.lol تحت إذا تبي تبقى بهالجانب من البلد. القائمة بس اللي بالكتالوج، مو ترتيب.`,
  "serene-coffee-roastery": `**محمصة سيرين** بقائمة الحمراء على wain.lol — صفحة الحزام الشرقي، مو العليا ومو كافد. وسوم الكتالوج على البطاقة: محمصة. باقي أسماء الحمراء تحت إذا هذي مو الوقف.`,
  ...
  "zeila-al-hamra": `**زَيّلا** بقائمة الحمراء على wain.lol — الحزام الشرقي، مو مطوية مع غرناطة جنبهم. أماكن الحمراء الثانية بالكتالوج تحت.`,
  ...
  "drip-al-hamra": `هذي صفحة **دريب** على wain.lol للحمراء — دبوس الحمراء، مو بطاقة دريب العليا. باقي أسماء الحمراء بالكتالوج تحت إذا تبي تبقى بهالحي.`,
  ...
  "silo-cafe-al-yarmouk": `**سايلو محمصة وقهوة مختصة** بقائمة اليرموك على wain.lol — أبعد شرقًا من الحمراء، مو صفحة الحمراء. وسوم الكتالوج على البطاقة: محمصة. باقي أسماء اليرموك تحت إذا هذي مو الوقف.`,
  "nosound-al-yarmouk": `هذي صفحة **نوساوند** على wain.lol لليرموك — دبوس اليرموك، مو بطاقة نوساوند النرجس ولا قرطبة. باقي أسماء اليرموك بالكتالوج تحت إذا تبي تبقى بهالحي.`,
  "obo-speciality-al-yarmouk": `**اوبو للقهوة المختصة** بالكتالوج في اليرموك — دبوسها شرق الرياض، مو بطاقة اوبو قرطبة. باقي أسماء اليرموك اللي ضفناها مربوطة تحت.`,
  ...
  "coffee-address-al-yarmouk": `**عنوان القهوة** بالكتالوج في اليرموك على wain.lol. هذي دبوس اليرموك، مو بطاقة عنوان القهوة بالحمراء. ما نخترع زيادة؛ قهاوي اليرموك الثانية اللي ضفناها مربوطة تحت.`,
  "aleel-roastery-al-yarmouk": `اليرموك فيها **محمصة أليل** بالكتالوج. وسوم الكتالوج على البطاقة: محمصة. هذي البطاقة إذا تبي هالاسم من القائمة بعد الحمراء. الباقي بنفس الحي تحت.`,
  ...
  "ratio-speciality-al-yarmouk": `**ريشيو** بقائمة اليرموك — بطاقة اليرموك، مو مطوية مع الحمراء جنبهم. أماكن اليرموك الثانية بالكتالوج تحت.`,
