...
const CNI_BLURBS_AR: Record<string, string> = {
  ...
  "zeila-al-hamra": `إذا تدور **زَيّلا** بالحمراء، هذي البطاقة اللي عندنا على wain.lol. الحزام الشرقي، مو مطوية مع غرناطة جنبهم. أماكن الحمراء الثانية بالكتالوج تحت.`,
