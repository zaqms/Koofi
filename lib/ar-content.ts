...
اختار اللي تمشي معك، افتح البطاقة، واضغط **ودّني هناك** إذا جاهز تروح. الساعات والدبوس على قوقل ماب — ما ننسخها هنا، عشان تشوف اللي محدّث.

## أحياء ثانية قريبة

تستاهل نظرة إذا مو لازم كافد:
...
wain.lol دليل قهوة صغير في الرياض. تقدر تطلب ثلاث اقتراحات، أو تتفرج على الحي كذا. مو موقع تقييمات ولا تطبيق توصيل — قائمة نظيفة مع الخريطة إذا تبي الطريق. التفاصيل الأطول في [عن وين](/about). وإذا تبني أدوات أو agents، الكتالوج العام في [\`/llms.txt\`](/llms.txt).
...
كافد جنبكم إذا تبي هالقائمة بدل: [مقاهي في كافد](/coffee-shops/kafd).
...
قائمة قصيرة عمداً — إطلاق خفيف، بس اللي ضفناه فعلاً. افتح البطاقة إذا واحدة تمشي، بعدين **ودّني هناك** للدبوس والساعات على قوقل ماب. ما نلصق الساعات بالصفحة.
...
wain.lol يساعدك تلقى قهوة بالرياض — اطلب ثلاث اقتراحات، أو افتح قائمة حي كذا. مو موقع تقييمات ومو توصيل. [عن وين](/about) فيه الشرح الأطول؛ [\`/llms.txt\`](/llms.txt) الكتالوج العام إذا تبيه مقروء للآلات.
...
export const GOLD_MASTER_GATE_AR = {
  ...
  markdown: `تدور قهوة مختصة بالورود — الشوارع الأهدأ جنب كافد؟ **The Gate Specialty Coffee** موجودة بقائمتنا لهالحي بالرياض. الاسم بالكتالوج نفس الإنجليزي؛ ما نخترع اسم عربي للبراند.

بمنطقة مول العليا بالورود، الناس غالباً يذكرون القهوة المختصة، التشيزكيك وحلويات ثانية، الطاقم الودود، ومكان هادي وجميل تفك فيه. جلسة هادية تريح إذا تبي تهدأ شوي. البطاقة بسيطة: الاسم، الورود، و**ودّني هناك** عشان قوقل ماب يوريك الدبوس وساعات اليوم. ما فيه منيو ولا تقييم ولا أوقات دوام منسوخة هنا.
...
const DISTRICT_COPY_AR: Partial<Record<NeighborhoodId, DistrictLead>> = {
  "al-narjis": {
    lead: `النرجس فوق، شمال الرياض — مو أبراج كافد، ومو نفس قائمة الورود جنبهم. إذا أنت بهالجهة وتبي قهوة من الكتالوج، هذي صفحة النرجس على wain.lol.
...
القائمة أطول من سبع كافد ومن أربع الورود. هذا بس عدد اللي ضفناه من النرجس — مو إن هالحي «حي القهوة». افتح بطاقة إذا الاسم يمشي. خلّها إذا ما يمشي.`,
    hereIntro: `فيه **{count}** قهاوي من النرجس بالكتالوج اليوم:`,
    hereOutro: `الأسماء من الكتالوج مثل ما ضفناها. افتح البطاقة إذا واحدة تمشي، بعدين **ودّني هناك** للدبوس والساعات على قوقل ماب. ما نلصق الساعات هنا.`,
    nearbyIntro: `إذا النرجس مو الوقف، هالقوائم الشمالية جنبكم بالموقع:`,
    about: `wain.lol دليل قهوة صغير في الرياض. اطلب ثلاث اقتراحات، أو تفرّج على قائمة حي مثل النرجس. مو تقييمات، مو توصيل. [عن وين](/about) فيه الملاحظة الأطول؛ [\`/llms.txt\`](/llms.txt) الكتالوج العام.
...
الرياض بس للحين. ناقصك مكان؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  diriyah: {
    lead: `الدرعية غرب اللفّة الشمالية المعتادة — جاكس، البجيري، البلد القديم. هذي مجموعة الدرعية اللي حطيناها على wain.lol للحين، مو قائمة مكاتب كافد ولا ترتيب على مستوى المدينة.`,
    ...
    about: `wain.lol يساعدك تلقى قهوة بالرياض — ثلاث اقتراحات، أو قائمة حي مثل الدرعية. [عن وين](/about) فيه الشرح الأطول؛ [\`/llms.txt\`](/llms.txt) الكتالوج العام.

الرياض بس للحين. تعرف محل ناقصنا؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  "al-yasmin": {
    lead: `الياسمين حي شمال الرياض جنب الملقا والنرجس. هذي قهاوي الياسمين اللي ضفناها على wain.lol للحين — قائمة أطول من بعض الأحياء، وبس اللي بالكتالوج فعلاً.`,
    hereIntro: `فيه **{count}** قهاوي من الياسمين بالقائمة الحين:`,
    hereOutro: `اختار اسم، افتح البطاقة، واستخدم **ودّني هناك** إذا تبي الدبوس. ما ننسخ الساعات هنا.`,
    about: `تفرّج على الحي أو اسأل الشات. wain.lol قائمة رياض نظيفة مع الخريطة. المزيد في [عن وين](/about). للـ agents فيه [\`/llms.txt\`](/llms.txt).
...
الرياض بس للحين. ناقصك مكان تحبه؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  "al-mughrizat": {
    ...
    about: `wain.lol دليل قهوة صغير في الرياض. تقدر تطلب ثلاث اقتراحات، أو تفتح صفحة حي كذا. [عن وين](/about). [\`/llms.txt\`](/llms.txt) إذا تبي الكتالوج مقروء للآلات.

الرياض بس للحين. ارمي رابط قوقل ماب من الموقع إذا ناقصنا محل.`,
  },
  "al-rabwah": {
    lead: `الربوة شرق خط العليا–الورود. هذي قهاوي الربوة بالكتالوج اليوم — قائمة حي، مو «أفضل قهاوي».`,
    ...
    about: `wain.lol يساعدك تلقى قهوة بالرياض — اطلب ثلاث اقتراحات، أو افتح قائمة حي مثل الربوة. مو تقييمات ومو توصيل. [عن وين](/about)؛ [\`/llms.txt\`](/llms.txt).

الرياض بس للحين. تعرف محل ناقصنا؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  "as-sahafah": {
    lead: `الصحافة شمال جنب كافد، بس هذي قائمتها هي. إذا تبي صفحة الحي المالي فهي [مقاهي في كافد](/coffee-shops/kafd). هذي قهاوي الصحافة اللي ضفناها للحين.`,
    ...
    about: `wain.lol دليل قهوة صغير في الرياض. ثلاث اقتراحات، أو قائمة حي. [عن وين](/about) فيه الملاحظة الأطول؛ [\`/llms.txt\`](/llms.txt) الكتالوج العام.

الرياض بس للحين. ناقصك مكان؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  ghirnatah: {
    lead: `غرناطة شرق الرياض — جهة ثانية عن كافد. هذي قهاوي جهة غرناطة اللي حطيناها على wain.lol للحين.`,
    hereIntro: `فيه **{count}** قهاوي من غرناطة بالقائمة الحين:`,
    hereOutro: `اختار اللي تمشي، افتح البطاقة، واضغط **ودّني هناك** إذا تبي الدبوس. ما نلصق الساعات هنا.`,
    about: `تفرّج على الحي أو اسأل الشات. wain.lol قائمة رياض نظيفة مع الخريطة. المزيد في [عن وين](/about). [\`/llms.txt\`](/llms.txt) للـ agents.
...
الرياض بس للحين. ارمي رابط قوقل ماب من الموقع إذا ناقصنا محل.`,
  ...
  hittin: {
    ...
    about: `wain.lol دليل قهوة صغير في الرياض. اطلب ثلاث اقتراحات، أو تفرّج على قائمة حي. [عن وين](/about). [\`/llms.txt\`](/llms.txt).

الرياض بس للحين. ناقصك مكان تحبه؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  "al-malqa": {
    lead: `الملقا حي شمال الرياض على wain.lol. هذي مجموعة الملقا من الكتالوج — مو ترتيب، بس الأسماء اللي ضفناها.`,
    ...
    about: `wain.lol يساعدك تلقى قهوة بالرياض — ثلاث اقتراحات، أو قائمة كذا. [عن وين](/about)؛ [\`/llms.txt\`](/llms.txt).

الرياض بس للحين. تعرف محل ناقصنا؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  "al-nakheel": {
    lead: `صفحة النخيل هي قهاوي النخيل بالقائمة اليوم — حي شمال الرياض، مو ترتيب على مستوى المدينة.`,
    ...
    about: `تفرّج على الحي أو اسأل الشات. المزيد في [عن وين](/about). [\`/llms.txt\`](/llms.txt) الكتالوج العام.

الرياض بس للحين. ارمي رابط قوقل ماب من الموقع إذا ناقصنا محل.`,
  },
  olaya: {
    lead: `العليا الخط الوسط اللي ناس كثير تعرفه. هذي مجموعة العليا على wain.lol، وكل وحدة عليها رابط خريطة — مو مقال «أفضل قهاوي العليا».`,
    ...
    about: `wain.lol دليل قهوة صغير في الرياض. تقدر تطلب ثلاث اقتراحات، أو تتفرج على حي مثل العليا. [عن وين](/about). [\`/llms.txt\`](/llms.txt).

الرياض بس للحين. ناقصك مكان تحبه؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  sulimaniyah: {
    lead: `السليمانية جنب العليا والتحلية. هذي قهاوي السليمانية بالكتالوج للحين — صفحتها هي، مو مطوية مع العليا.`,
    hereIntro: `فيه **{count}** قهاوي من السليمانية بالكتالوج اليوم:`,
    hereOutro: `اختار واحدة، افتح البطاقة، واضغط **ودّني هناك** إذا جاهز. ما ننسخ الساعات هنا.`,
    about: `wain.lol يساعدك تلقى قهوة بالرياض — اطلب ثلاث اقتراحات، أو افتح قائمة حي. [عن وين](/about)؛ [\`/llms.txt\`](/llms.txt).
...
الرياض بس للحين. تعرف محل ناقصنا؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  "al-rabi": {
    ...
    about: `wain.lol دليل قهوة صغير في الرياض. [عن وين](/about). [\`/llms.txt\`](/llms.txt).
...
الرياض بس للحين. ارمي رابط قوقل ماب من الموقع إذا ناقصنا محل.`,
  ...
  "al-masif": {
    ...
    about: `تفرّج على الحي أو اسأل الشات. المزيد في [عن وين](/about). [\`/llms.txt\`](/llms.txt).
...
الرياض بس للحين. ناقصك مكان؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  "al-rahmaniyyah": {
    ...
    hereOutro: `**ودّني هناك** يفتح الخريطة للدبوس. ما نلصق الساعات هنا.`,
    about: `wain.lol يساعدك تلقى قهوة بالرياض. [عن وين](/about)؛ [\`/llms.txt\`](/llms.txt).

الرياض بس للحين. تعرف محل ناقصنا؟ ارمي رابط قوقل ماب من الموقع.`,
  },
  "al-shohda": {
    lead: `الشهداء قائمة شرق الرياض صغيرة — قهوة وحدة ضفناها للحين. مو نسخة من غرناطة جنبهم.`,
...
الرياض بس للحين. ارمي رابط قوقل ماب من الموقع إذا ناقصنا محل.`,
  ...
  "al-safa": {
    lead: `الصفا حي شرق الرياض بالقائمة. هذي أماكن الصفا اللي ضفناها — صفحتها هي، مو مطوية مع غرناطة.`,
    hereIntro: `فيه **{count}** قهاوي من الصفا على wain.lol الحين:`,
    hereOutro: `افتح البطاقة إذا واحدة تمشي، بعدين **ودّني هناك** للدبوس والساعات على قوقل ماب.`,
    about: `اطلب ثلاث اقتراحات، أو تفرّج على قائمة حي. [عن وين](/about)؛ [\`/llms.txt\`](/llms.txt).
...
الرياض بس للحين. تعرف محل ناقصنا؟ ارمي رابط قوقل ماب من الموقع.`,
  ...
  qurtubah: {
    lead: `قرطبة حي شرق الرياض وقائمتها أطول من أكثر الأحياء. هذي قهاوي قرطبة على wain.lol — بعد بس اللي بالكتالوج.`,
    hereIntro: `فيه **{count}** قهاوي من قرطبة بالقائمة الحين:`,
    hereOutro: `اختار اسم، افتح البطاقة، واستخدم **ودّني هناك** إذا تبي الدبوس. ما ننسخ الساعات هنا.`,
    about: `wain.lol يساعدك تلقى قهوة بالرياض — ثلاث اقتراحات، أو قائمة حي مثل قرطبة. [عن وين](/about)؛ [\`/llms.txt\`](/llms.txt).

الرياض بس للحين. ارمي رابط قوقل ماب من الموقع إذا ناقصنا محل.`,
  },
  "an-nazhah": {
    lead: `النزهة بالكتالوج كقائمة حي لوحدها. هذي الأماكن اللي ضفناها للحين — مو ترتيب على مستوى المدينة.`,
...
const CNI_BLURBS_AR: Record<string, string> = {
  "core-coffee-and-roastery-al-narjis": `تدور قهوة بالنرجس شمال الرياض؟ **كور قهوة ومحمصة** موجودة بقائمتنا لهالحي — نفس صفحة النرجس مع كاف لاب وريبوستري، مو قائمة كافد. البطاقة بسيطة: الاسم، النرجس، و**ودّني هناك** عشان قوقل ماب يوريك الدبوس وساعات اليوم. ما فيه منيو ولا تقييم ولا أوقات دوام منسوخة هنا. ما نخترع جو من التقييمات؛ بس اللي بالكتالوج. إذا تبي اسم ثاني من نفس القائمة الشمالية، الباقي تحت.`,
  "caf-lab-al-narjis": `**كاف لاب** من أماكن النرجس على wain.lol. إذا أنت شمال وتبي هالبطاقة، أنت بالمكان الصح — مو صفحة كافد، مو ترتيب المدينة. الصفحة خفيفة: الاسم، الحي، و**ودّني هناك** للدبوس. الساعات على قوقل ماب، مو هنا. ما نلصق منيو ولا تقييم. باقي أسماء النرجس بالكتالوج مربوطة تحت إذا تبي تنتقل بنفس الحي.`,
  "repository-coffee-roasters-al-narjis": `**محمصة ريبوستري** بالنرجس مع الأسماء الثانية شمال الرياض. هذي بطاقة wain.lol للمحل — مو تقييم، مو منيو، ومو نسخة من كور أو كاف لاب. افتح **ودّني هناك** إذا تبي دبوس الخريطة وساعات اليوم. ما ننسخ أوقات دوام هنا. باقي قائمة النرجس تحت إذا تبي اسم ثاني من نفس الكتالوج.`,
  "jazel-speciality-cafe-diriyah": `**جازل** بقائمة الدرعية على wain.lol — غرب اللفّة الشمالية المعتادة، مو مطوية مع العليا ولا كافد. البطاقة: الاسم، الدرعية، و**ودّني هناك**. ما نلصق ساعات ولا تقييم ولا منيو بالصفحة. إذا هذي مو الوقف، أماكن الدرعية الثانية بنفس قائمة الحي مربوطة تحت — بس اللي ضفناه فعلاً.`,
  "qirat-al-yasmin": `**قيراط** من قهاوي الياسمين على wain.lol. إذا تتفرج على هالحي شمال الرياض جنب الملقا والنرجس، هذي البطاقة. الاسم، الياسمين، **ودّني هناك** للدبوس. الساعات على قوقل ماب، مو منسوخة هنا. ما نخترع زيادة. باقي أسماء الياسمين بالكتالوج تحت إذا تبي تقارن بنفس القائمة.`,
  "cred-al-mughrizat": `المغرزات قائمة قصيرة على wain.lol، و**كريد** القهوة اللي فيها اليوم. نضيف اللي عندنا بس، فالصفحة هالبطاقة: الاسم، المغرزات، و**ودّني هناك** عشان قوقل ماب يوريك الدبوس وساعات اليوم. ما فيه منيو ولا تقييم ولا أوقات دوام هنا. ما نخترع جيران عشان نملا الصفحة. إذا تبي قائمة حي أطول، صفحة الحي تشير لأحياء قريبة نغطيها فعلاً. ما فيه قهوة ثانية بنفس القائمة للحين.`,
  "sulalat-coffee-ar-rabwah": `**سلالات القهوة** بالربوة — شرق خط العليا–الورود، صفحة حي لوحدها. البطاقة بسيطة: الاسم، الربوة، **ودّني هناك** لدبوس قوقل ماب. ما ننسخ ساعات ولا تقييم ولا منيو هنا. أماكن الربوة الثانية بالكتالوج تحت إذا تبي اسم ثاني من نفس القائمة. هذي مو مقال «أفضل قهاوي».`,
  "taim-specialty-coffee-as-sahafah": `**تَيْم** بقائمة الصحافة، جنب كافد بس مو على صفحة كافد. هذي بطاقة wain.lol: الاسم، الصحافة، و**ودّني هناك** إذا تبي الدبوس. الساعات على قوقل ماب، مو هنا. ما نلصق منيو ولا تقييم ولا أوقات دوام. باقي أسماء الصحافة اللي ضفناها مربوطة تحت — قائمة قصيرة، بس اللي بالكتالوج. ما نخترع مجموعة أطول عشان الصفحة تبين مشغولة.`,
  "archi-ghirnatah": `**ارتشي غرناطة** بقائمة غرناطة — شرق الرياض، جهة ثانية عن كافد. البطاقة: الاسم، غرناطة، و**ودّني هناك**. ما فيه منيو ولا تقييم ولا أوقات دوام منسوخة هنا. أماكن جهة غرناطة الثانية على wain.lol تحت إذا تبي تبقى بهالجانب من البلد. القائمة بس اللي بالكتالوج، مو ترتيب.`,
};
...
function defaultDistrictCopy(district: NeighborhoodId): DistrictLead {
  ...
  return {
    ...
    hereOutro: `افتح البطاقة إذا واحدة تمشي، بعدين **ودّني هناك** للدبوس والساعات على قوقل ماب. ما نلصق الساعات هنا.`,
    about: `wain.lol دليل قهوة صغير في الرياض. اطلب ثلاث اقتراحات، أو تفرّج على قائمة حي. [عن وين](/about). [\`/llms.txt\`](/llms.txt).
...
export function districtArMarkdown(district: NeighborhoodId): string {
  ...
  const hereOutro =
    copy.hereOutro ??
    `افتح البطاقة إذا واحدة تمشي، بعدين **ودّني هناك** للدبوس والساعات على قوقل ماب. ما نلصق الساعات هنا.`;
...
function defaultCafeBlurb(shop: Shop): string {
  ...
  const extras = [
    `ما نخترع قصص من التقييمات — بس الاسم والحي ورابط الخريطة.`,
    `هذي بطاقة كتالوج، مو مراجعة. إذا الاسم يمشي افتح **ودّني هناك**.`,
  ...
  const vibeLine =
    vibe.length > 0 && vibe[0] !== "قهوة"
      ...
      : "";
  return `${opener(name, district)}${vibeLine} البطاقة بسيطة: الاسم، ${district}، و**ودّني هناك** عشان قوقل ماب يوريك الدبوس وساعات اليوم. ما فيه منيو ولا تقييم ولا أوقات دوام منسوخة هنا. ${extra} الرياض بس للحين. إذا تبي باقي الحي، صفحة الحي مربوطة تحت.`;
}
