...
assert(live.length === 40, `expected 40 live districts, got ${live.length}`);
assert(
...
assertDistrictTop3("الحمراء", "ar", "al-hamra");
assertDistrictTop3("Al Hamra", "en", "al-hamra");
assertDistrictTop3("hamra", "en", "al-hamra");
assert(extractPrimaryDistrict("الحمراء") === "al-hamra", "الحمراء");
assert(extractPrimaryDistrict("Al Hamra") === "al-hamra", "Al Hamra");
assert(extractPrimaryDistrict("al hamra") === "al-hamra", "al hamra");
assertDistrictTop3("اليرموك", "ar", "al-yarmouk");
assertDistrictTop3("Al Yarmouk", "en", "al-yarmouk");
assertDistrictTop3("yarmouk", "en", "al-yarmouk");
assert(extractPrimaryDistrict("اليرموك") === "al-yarmouk", "اليرموك");
assert(extractPrimaryDistrict("Al Yarmouk") === "al-yarmouk", "Al Yarmouk");
assert(extractPrimaryDistrict("al yarmouk") === "al-yarmouk", "al yarmouk");
assert(extractPrimaryDistrict("al-yarmuk") === "al-yarmouk", "al-yarmuk typo alias");
assertDistrictTop3("النهضة", "ar", "al-nahdah");
assertDistrictTop3("Al Nahdah", "en", "al-nahdah");
assertDistrictTop3("nahdah", "en", "al-nahdah");
assert(extractPrimaryDistrict("النهضة") === "al-nahdah", "النهضة");
assert(extractPrimaryDistrict("Al Nahdah") === "al-nahdah", "Al Nahdah");
assert(extractPrimaryDistrict("al nahdah") === "al-nahdah", "al nahdah");
assert(extractPrimaryDistrict("al-nahda") === "al-nahdah", "al-nahda typo alias");
assertDistrictTop3("الريان", "ar", "al-rayyan");
assertDistrictTop3("Al Rayyan", "en", "al-rayyan");
assertDistrictTop3("rayyan", "en", "al-rayyan");
assert(extractPrimaryDistrict("الريان") === "al-rayyan", "الريان");
assert(extractPrimaryDistrict("Al Rayyan") === "al-rayyan", "Al Rayyan");
assert(extractPrimaryDistrict("ar-rayyan") === "al-rayyan", "ar-rayyan alias");
assertDistrictTop3("الروضة", "ar", "al-rawdah");
assertDistrictTop3("Al Rawdah", "en", "al-rawdah");
assert(extractPrimaryDistrict("المنار") === "al-manar", "المنار");
assert(extractPrimaryDistrict("Al Manar") === "al-manar", "Al Manar");
assert(extractPrimaryDistrict("الروابي") === "al-rawabi", "الروابي");
assert(extractPrimaryDistrict("Al Rawabi") === "al-rawabi", "Al Rawabi");
assert(extractPrimaryDistrict("الفيحاء") === "al-fayha", "الفيحاء");
assert(extractPrimaryDistrict("Al Fayha") === "al-fayha", "Al Fayha");
assert(extractPrimaryDistrict("الرقبان") === "al-raqban", "الرقبان");
assert(extractPrimaryDistrict("Al Raqban") === "al-raqban", "Al Raqban");
assertDistrictTop3("المونسية", "ar", "al-munsiyah");
assertDistrictTop3("Al Munsiyah", "en", "al-munsiyah");
assertDistrictTop3("munsiyah", "en", "al-munsiyah");
assert(extractPrimaryDistrict("المونسية") === "al-munsiyah", "المونسية");
assert(extractPrimaryDistrict("Al Munsiyah") === "al-munsiyah", "Al Munsiyah");
assert(extractPrimaryDistrict("al munsiyah") === "al-munsiyah", "al munsiyah");
assert(extractPrimaryDistrict("al-munisiyah") === "al-munsiyah", "al-munisiyah typo alias");
assert(extractPrimaryDistrict("الندى") === "an-nada", "الندى");
assert(extractPrimaryDistrict("An Nada") === "an-nada", "An Nada");
assert(extractPrimaryDistrict("an nada") === "an-nada", "an nada");
assert(extractPrimaryDistrict("الحي الدبلوماسي") === "diplomatic-quarter", "الحي الدبلوماسي");
assert(extractPrimaryDistrict("Diplomatic Quarter") === "diplomatic-quarter", "Diplomatic Quarter");
assert(extractPrimaryDistrict("السفارات") === "diplomatic-quarter", "السفارات alias");
...
assertDistrictTop3("الوادي", "ar", "al-wadi");
assertDistrictTop3("Al Wadi", "en", "al-wadi");
assert(extractPrimaryDistrict("الوادي") === "al-wadi", "الوادي");
