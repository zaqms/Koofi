...
assert(listDiscoveryShops().length === 292, `specialty discovery 285→292, got ${listDiscoveryShops().length}`);
assert(listRealShops().length === 359, `catalog 352→359 with Ar Rabwah Scout-7, got ${listRealShops().length}`);
